...
def build_strategy_with_openai(
    ...
    prompt = (
        ...
        "- KSA는 내부 추적용 근거입니다. KSA의 task_statement·observable_behavior를 읽고 그 의미를 "
        "공고·직무기술서의 구체 대상, 제약, 판단 또는 행동으로 자유롭게 번역하세요. public surface나 "
        "official factor를 문장 골격으로 복사하지 말고, KSA마다 가장 잘 드러나는 한 가지 관찰 초점만 "
        "남기세요. 면접 형태별 공통 문장, STAR 슬롯, 문서·수치·기록·피드백 목록을 자동 삽입하지 마세요.\n"
        "\n"
        "[주질문 작성 필수 기준]\n"
